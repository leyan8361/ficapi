...
//    SMS_SEND_1DAY_LIMIT(1019,"单个手机号日下发短信条数超过设定的上限"),
    ...
    WE_CHAT_PAY_FAILED(6007,"WE_CHAT_PAY_FAILED"),
    WE_CHAT_PAY_ORDER_NOT_EXIST(6008,"WE_CHAT_PAY_ORDER_NOT_EXIST"),
    WE_CHAT_PAY_QUERY_FAILED(6009,"WE_CHAT_PAY_QUERY_FAILED"),
    WE_CHAT_PAY_REFUND_REJECT(6010,"WE_CHAT_PAY_REFUND_REJECT"),
    WE_CHAT_PAY_APPLE_REJECT_FAILED(6011,"WE_CHAT_PAY_APPLE_REJECT_FAILED"),
    /**
     * System Error
     */
